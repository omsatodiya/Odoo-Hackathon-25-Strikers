      ...
      <CardContent className="pt-6">
        <div className="flex items-start justify-between">
          <div className="flex items-start space-x-4">
            <Avatar>
              <AvatarImage src={type === 'sent' ? request.receiverAvatar : request.senderAvatar} />
              <AvatarFallback>
                {type === 'sent' ? request.receiverName.charAt(0) : request.senderName.charAt(0)}
              </AvatarFallback>
            </Avatar>
            <div>
        ...
        {type === 'sent' && request.status === 'pending' && (
          <div className="mt-4 flex justify-end">
            <Button variant="destructive" onClick={onDelete}>Delete Request</Button>
          </div>
        )}
      </CardContent>
    </Card>
