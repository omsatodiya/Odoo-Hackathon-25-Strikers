...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: "Email", href: "mailto:contact@skillswap.com", icon: Mail },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4 max-w-md">
              Connect, learn, and grow with SkillSwap. The platform that brings
              together learners and experts to share knowledge and build
